...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:01}Figure \arabic{figure}.}{An example result of querying a nidm-results object (RDF) with the nidm-api returns JavaScript Object Notation (JSON).}
\end{figure}
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:02}Figure \arabic{figure}.}{The tool provides an interactive web interface to contribute new queries.}
\end{figure}
...
\end{center}
 \textbf{\refstepcounter{figure}\label{fig:03}Figure \arabic{figure}.}{The nidm-viewer in the NeuroVault database queries nidm-result objects to generate an interactive table and statistical brain map.}
\end{figure}
